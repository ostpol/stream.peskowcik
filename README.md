...
> All implementation code was generated by an AI system (ChatGPT).
> My own contribution was limited to understanding and describing the ARD Mediathek API and defining the desired behavior. No manual code review, optimization, or architectural design was performed beyond basic plausibility checks.
